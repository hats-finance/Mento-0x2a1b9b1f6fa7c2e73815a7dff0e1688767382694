...
- Duration: 2 weeks
- Maximum Reward: $15,998.38
- Submissions: 45
- Total Payout: $1,559.84 distributed among 3 participants.
...
The Hats.finance audit competition for Mento aimed to enhance security within the web3 ecosystem by leveraging a decentralized audit competition model that employs skilled auditors. This competition was hosted to fortify Mento's Locking Contracts as they transition to Celo's L2 infrastructure. During the two-week event, 45 submissions were evaluated, and a total payout of $1,559.84 was distributed among three participants from a maximum potential reward of $15,998.38. The audit scope involved assessing the updated Locking Contracts, focusing on changes linked to the L2 transition like block time adjustments, additional L2 variables, and temporary governance roles for MentoLabs MultiSig. These modifications aim to maintain consistent governance voting periods and protect user Locks during the transition. Post-audit, successful updates will allow for a seamless migration and governance implementation on Celo's L2. Hats.finance’s innovative competition approach emphasizes efficiency by rewarding only successful vulnerability identifications, setting a standard for decentralized security audits.
